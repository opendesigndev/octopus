...
import BenchmarkHTTPRequestWeb from './benchmark-http-request-web.js'
import BenchmarkSimpleWeb from './benchmark-simple-web.js'
...
import type { ResponseBenchmarkProps } from './benchmark-http-request-web.js'

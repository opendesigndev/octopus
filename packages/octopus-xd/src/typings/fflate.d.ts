/**
 * For some reason `fflate` stopped compiling after some changes in package.json.
 * Types are not properly resolved so this file mirrors them by explicit module declaration.
 */
...
declare module 'fflate' {
   ...
   */
  export function unzipSync(data: Uint8Array, opts?: UnzipOptions): Unzipped
}

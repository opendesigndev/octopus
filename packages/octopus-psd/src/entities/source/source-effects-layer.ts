...
export class SourceLayerEffects extends SourceEntity {
  ...
  get solidFill(): SourceEffectFill | undefined {
    ...
    return fill !== undefined && fill.enab !== false ? new SourceEffectFill(this._lfx2?.SoFi) : undefined
  }

  @firstCallMemo()
  get gradientFill(): SourceEffectFill | undefined {
    const fill = this._lfx2?.GrFl
    return fill !== undefined && fill.enab !== false ? new SourceEffectFill(this._lfx2?.GrFl) : undefined
  }
  ...
  get patternFill(): SourceEffectFill | undefined {
    ...
    return fill !== undefined && fill.enab !== false ? new SourceEffectFill(this._lfx2?.patternFill) : undefined
  }
  ...
  get stroke(): SourceEffectStroke | undefined {
    ...
    return fill !== undefined && fill.enab !== false ? new SourceEffectStroke(fill) : undefined
  }
  ...
  get innerGlow(): SourceEffectShadow | undefined {
    ...
    return shadow !== undefined && shadow.enab !== false ? new SourceEffectShadow(shadow) : undefined
  }
  ...
  get satin(): SourceEffectSatin | undefined {
    ...
    return satin !== undefined && satin.enab !== false ? new SourceEffectSatin(this._lfx2?.ChFX) : undefined
  }
  ...
  get bevelEmboss(): SourceEffectBevelEmboss | undefined {
    ...
    return bevelEmboss !== undefined && bevelEmboss.enab != false ? new SourceEffectBevelEmboss(bevelEmboss) : undefined
  }
}

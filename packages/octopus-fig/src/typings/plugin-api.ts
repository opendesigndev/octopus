...
interface TextSublayerNode extends MinimalFillsMixin {
  ...
  getRangeFontWeight(start: number, end: number): number | 'Mixed'
  ...
  getRangeHyperlink(start: number, end: number): HyperlinkTarget | null | 'Mixed'
  ...
  getRangeListOptions(start: number, end: number): TextListOptions | 'Mixed'
  setRangeListOptions(start: number, end: number, value: TextListOptions): void
  getRangeIndentation(start: number, end: number): number | 'Mixed'

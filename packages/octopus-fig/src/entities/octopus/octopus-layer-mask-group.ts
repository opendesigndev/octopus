...
import { convertId, convertLayerBlendMode, convertTransform } from '../../utils/convert.js'
...
export class OctopusLayerMaskGroup {
  ...
  static createBackgroundMaskGroup({
    ...
    const transform = isTopLayer ? topComponentTransform : convertTransform(sourceLayer.transform)

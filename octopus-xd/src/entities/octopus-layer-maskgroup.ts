...
import { RawGroupLayer, RawShapeLayer, RawShapeMaskGroupLayer } from '../typings/source'
...
export default class OctopusLayerMaskGroup extends OctopusLayerCommon {
  ...
  _initMaskLayer(): OctopusLayerShape | null {

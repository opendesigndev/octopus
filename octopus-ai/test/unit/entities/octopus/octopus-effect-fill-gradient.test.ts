...
import type { Coord } from '../../../../src/typings'

describe('entities/octopus/octopus-effect-fill-gradient', () => {
  ...
  describe('_parseGradient', () => {
    it('returns from _parseLinearGradient when shadingType is 2', () => {
      ...
      const _parseLinearGradientMock = jest.fn().mockReturnValueOnce(_parseLinearGradientMockReturnValue)
      octopusEffectGradientFill['_parseLinearGradient'] = _parseLinearGradientMock
    ...
    it('returns from  _parseLinearGradient when shadingType is 2', () => {
      ...
      const _parseRadialGradientMockReturnValue = {}
      const _parseRadialGradientMock = jest.fn().mockReturnValueOnce(_parseRadialGradientMockReturnValue)
      octopusEffectGradientFill['_parseRadialGradient'] = _parseRadialGradientMock
      expect(octopusEffectGradientFill['_parseGradient']()).toBe(_parseRadialGradientMockReturnValue)
    })
  })
})

...
jest.mock('../../../../src/entities/octopus/octopus-layer-common', () => {
  return {
    __esModule: true,
...
describe('entities/octopus/octopus-layer-shape-shape-adapter', () => {
  ...
  describe('getPath', () => {
    ...
    it('returns octopous COMPOUND paths when sourceSubpaths on sourceLayer have >1 length', () => {
      const octopusLayerShapeShapeAdapter = getTestingOctopusLayerShapeShapeAdapter({
        subpaths: [
          {
            closed: true,

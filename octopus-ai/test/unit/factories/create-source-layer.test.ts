...
import { SourceLayerGroup } from '../../../src/entities/source/source-layer-group'
import { SourceLayerShape } from '../../../src/entities/source/source-layer-shape'
import { SourceLayerText } from '../../../src/entities/source/source-layer-text'
import { SourceLayerXObjectForm } from '../../../src/entities/source/source-layer-x-object-form'
import { SourceLayerXObjectImage } from '../../../src/entities/source/source-layer-x-object-image'
import { createSourceLayer } from '../../../src/factories/create-source-layer'

jest.mock('../../../src/entities/source/source-layer-shape')
jest.mock('../../../src/entities/source/source-layer-text')
jest.mock('../../../src/entities/source/source-layer-group')
jest.mock('../../../src/entities/source/source-layer-x-object-image')
jest.mock('../../../src/entities/source/source-layer-x-object-form')

describe('factories/create-source-layer', () => {
  describe('createSourcLayer', () => {
    ...
    it('returns null when rawLayer has no  type', () => {
      const rawLayer = {}
      const parent = {}
    ...
    it('returns SourceLayerXObjectImage when rawLayer.Type is XObject and resourcesXObject.Subtype is Form', () => {
      const rawLayer = { Type: 'XObject', Name: 'FM0' }

...
import { buildOctopusLayer, createOctopusLayer } from '../../../src/factories/create-octopus-layer'
...
import {
  ...
  uniqueIdFactory,
} from '../../../src/utils/layer'

jest.mock('../../../src/services/instances/text-layer-grouping-service', () => ({
  __esModule: true,
  textLayerGroupingService: jest.fn(),
}))

jest.mock('../../../src/factories/create-source-layer')
jest.mock('../../../src/services/conversion/layer-grouping-service')

import { createShape } from '../../../src/utils/create-shape'

import type { OctopusPoint } from '../../../src/utils/create-shape'

describe('utils/create-shape', () => {
  it('returns closed paper.Path', () => {
    const points = [

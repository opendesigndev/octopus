...
import { prepareSourceDesign } from './prepare-source-design.js'
import { createTempSaver } from './save-temp.js'

import type SourceArtboard from '../../src/entities/source/source-artboard.js'

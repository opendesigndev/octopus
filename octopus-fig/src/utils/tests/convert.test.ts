import { convertId, deconvertId } from '../convert'
...
describe('deconvertId', () => {
  function testExample(id: string, result: string): void {
    test(`deconvertId(${id}) to be ${result}`, () => {
      expect(deconvertId(id)).toBe(result)
    })
  }
  ...
  const examples: Example[] = [
    ['1-22-333-4444', '1:22:333:4444'],
    ['1_22_333_4444', '1;22;333;4444'],
    ['1-22_333-4444', '1:22;333:4444'],
    ['1_22:333_4444', '1;22:333;4444'],
    ['1-22_333-Background', '1:22;333:Background'],
    ['1-22_333:Background', '1:22;333:Background'],
    ['1-22_333_Background', '1:22;333;Background'],
    ['1-22_333;Background', '1:22;333;Background'],
  ]

...
// import ArtboardConverter, {
//   ArtboardConversionOptions,
// } from "./services/conversion/artboard-converter";
...
export default class OctopusPSDConverter {
  ...
  //     if (!normalized) {
  //       throw new Error(
  //         `File "package.json" not found, can't infer "version" property of Octopus`
  //       );
  //     }
